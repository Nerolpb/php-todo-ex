-- Active: 1760012767988@@127.0.0.1@3306@mysql
-- Active: 1759501367036@@127.0.0.1@3306@mysql
...
CREATE USER IF NOT EXISTS 'todolist'@'localhost' IDENTIFIED BY 'ChrisLoicUwU';
